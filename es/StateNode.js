...
function () {
  ...
  StateNode.prototype.getActions = function (resolvedConfig, isDone, transition, currentContext, _event, prevState, predictableExec) {
    ...
    var entryActions = entryStates.map(function (stateNode) {
      ...
      return {
        type: 'entry',
        actions: toActionObjects(predictableExec ? __spreadArray(__spreadArray([], __read(entryActions), false), __read(invokeActions)) : __spreadArray(__spreadArray([], __read(invokeActions), false), __read(entryActions)), _this.machine.options.actions)
      };
    }).concat({
      type: 'state_done',
    ...
    if (isDone) {
      var stopActions = toActionObjects(flatten(__spreadArray([], __read(resolvedConfig)).sort(function (a, b) {
        return b.order - a.order;
  ...
  StateNode.prototype.formatTransitions = function () {
    ...
    var formattedTransitions = flatten(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read(doneConfig), false), __read(invokeConfig), false), __read(onConfig), false), __read(eventlessConfig)).map(function (transitionConfig) {
