...
function () {
  ...
  StateNode.prototype.getActions = function (resolvedConfig, isDone, transition, currentContext, _event, prevState, predictableExec) {
    ...
    var doneEvents = utils.flatten(entryStates.map(function (sn) {
      ...
      events.push(actions.done(sn.id, sn.doneData),
    ...
    var entryActions = entryStates.map(function (stateNode) {
      ...
      return {
        type: 'entry',
        actions: actions.toActionObjects(predictableExec ? _tslib.__spreadArray(_tslib.__spreadArray([], _tslib.__read(entryActions), false), _tslib.__read(invokeActions)) : _tslib.__spreadArray(_tslib.__spreadArray([], _tslib.__read(invokeActions), false), _tslib.__read(entryActions)), _this.machine.options.actions)
      };
    }).concat({
      type: 'state_done',
    ...
    if (isDone) {
      var stopActions = actions.toActionObjects(utils.flatten(_tslib.__spreadArray([], _tslib.__read(resolvedConfig)).sort(function (a, b) {
        return b.order - a.order;
  ...
  StateNode.prototype.resolveRaisedTransition = function (state, _event, originalEvent, predictableExec) {
    ...
    state = this.transition(state, _event, undefined, predictableExec);
  ...
  StateNode.prototype.formatTransitions = function () {
    ...
    var formattedTransitions = utils.flatten(_tslib.__spreadArray(_tslib.__spreadArray(_tslib.__spreadArray(_tslib.__spreadArray([], _tslib.__read(doneConfig), false), _tslib.__read(invokeConfig), false), _tslib.__read(onConfig), false), _tslib.__read(eventlessConfig)).map(function (transitionConfig) {
