  ...
  function Interpreter(machine, options) {
    ...
    this.send = function (event, payload) {
      ...
      if (_this.status !== exports.InterpreterStatus.Running && !_this.options.deferEvents) {
        throw new Error("Event \"".concat(_event.name, "\" was sent to uninitialized service \"").concat(_this.machine.id
    ...
    this.sendTo = function (event, to, immediate) {
      ...
      if ('machine' in target) {
        ...
        if (_this.status !== exports.InterpreterStatus.Stopped || _this.parent !== target ||
        ...
        case actionTypes.start:
          {
            ...
            if (activity.type === types.ActionTypes.Invoke) {
              ...
              var id = activity.id,
                data = activity.data;
              if (!environment.IS_PRODUCTION) {
                utils.warn(!('forward' in activity),
                // tslint:disable-next-line:max-line-length
  ...
  Interpreter.prototype.stop = function () {
    ...
    scheduler.schedule(function () {
      ...
      var nextState = serviceScope.provide(_this, function () {
        var exitActions = utils.flatten(_tslib.__spreadArray([], _tslib.__read(_this.state.configuration)).sort(function (a, b) {
